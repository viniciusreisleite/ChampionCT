    ...
    with sync_playwright() as p:
        ...
        for acc in ACCOUNTS:
            ...
            for url in candidatos:
                ...
                print(f"  [NOVO POST] Processando: {url}")
                ...
                # 1. Se for Reel ou tiver tag video explicita no post, tenta yt-dlp
                ...
                # 2. Se nao for video ou yt-dlp nao achou formato de video, puxa como imagem HD
